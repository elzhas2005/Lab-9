...
apple = pygame.image.load(r"C:\Users\user\Desktop\Lab-9\pngwing.com (2).png").convert_alpha()#getting apple image
golden = pygame.image.load(r"C:\Users\user\Desktop\Lab-9\pngwing.com (2).png").convert_alpha()
